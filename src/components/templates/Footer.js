            ...
            <footer className="bg-dark padding-t-100 padding-b-100">
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-sm color-white">
                            <h5 className="padding-b-20 fw-bold">For Companies</h5>
                            <p>How it works</p>
                            <p>Sign Up</p>
                            <p>Login</p>
                        </div>
                        <div className="col-sm color-white">
                            <h5 className="padding-b-20 fw-bold">About Arttest</h5>
                            <p>Our story</p>
                            <p>Our mission</p>
                            <p>Careers</p>
                            <p>Blog</p>
                        ...
                        <div className="col-sm color-white">
                            <h5 className="padding-b-20 fw-bold">Legals</h5>
                            <p>Terms &amp; conditions</p>
                            <p>Privacy policy</p>
                        </div>
                    </div>
                </div>
                <div className="container color-white padding-t-100">
                    <div className="float-end">
                        <a href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" width={40} height={40} fill="#ffffff" className="bi bi-arrow-bar-up" viewBox="0 0 16 16">
