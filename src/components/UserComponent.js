...
import test from 'static/images/placeholder.svg'
...
function ProfileCover({ className }) {
    const classes = useStyles();
    // const { position, cover } = myProfile;
    // const { displayName } = authUser;

    const cover = {
        small: "https://res.cloudinary.com/trinhmai/image/upload/c_scale,f_auto,q_auto,w_1200/v1611411356/upload_minimal/covers/cover_1.jpg",
        medium: "https://res.cloudinary.com/trinhmai/image/upload/c_scale,f_auto,q_auto,w_1200/v1611411356/upload_minimal/covers/cover_1.jpg"
    }
    return (
      <div className={clsx(classes.root, className)}>
        ...
        <MyAvatar
          ...
          >
            <Typography variant="h4">MagicKID</Typography>
